(function () {
  ...
  function init(options) {
    ...
    appendMessage(
      messages,
      "bot",
      "שלום, אני Tiqa – בינה מלאכותית שמתמחה בדיני עבודה.\nאפשר לשתף אותי בעניין שלך ואני אנסה לעזור להבין מה המצב המשפטי.\nאם יש צורך, אעביר את הפרטים לעורך דין שיחזור אליך."
    );
