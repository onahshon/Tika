(function () {
  ...
  var SVG_BOT =
    ...
    '<rect x="11.2" y="3" width="1.6" height="2" rx="0.4"/>' +
    /* robot head with eye cutouts */
    '<path fill-rule="evenodd" d="' +
      'M4 7a3 3 0 0 1 3-3h10a3 3 0 0 1 3 3v5a3 3 0 0 1-3 3H7a3 3 0 0 1-3-3V7z' +
      'M8.8 8.5a1.2 1.2 0 1 1 2.4 0 1.2 1.2 0 0 1-2.4 0z' +
      'M12.8 8.5a1.2 1.2 0 1 1 2.4 0 1.2 1.2 0 0 1-2.4 0z' +
    '"/>' +
    /* suit jacket with lapels */
    '<path d="M9 15l-3 2-1 7h14l-1-7-3-2-1.5 2.5L12 17l-1.5-2.5L9 15z"/>' +
    /* tie */
    '<path d="M11.2 17l.8-1.2.8 1.2-.7 5h-.2l-.7-5z"/>' +
    '</svg>';
